...
import Foundation
var SampleProfile = JobSeeker(userID: "1", personalSummary: "hi", educations: nil, experiences: [Experience(jobTitle: "Bachelor's Degree in Design", companyName: "SampleCompany", startDate: "10/10/2013", endDate: "12/06/2015", city: "Manama"),Experience(jobTitle: "High School Diploma or equivalent", companyName: "alwissam", startDate: "1990", endDate: "2010", city: "Aali")], skills: [Skill(skillName: "Experience in curriculum design", skillLevel: "Advanced"),Skill(skillName: "Strong leadership skills", skillLevel: "Amazing"),Skill(skillName: "Experience in consulting", skillLevel: "intermediate"),Skill(skillName: "Portfolio of work", skillLevel: "good"),Skill(skillName: "SEO knowledge", skillLevel: "good"),Skill(skillName: "Strong writing samples", skillLevel: "excellent"),Skill(skillName: "AI/ML", skillLevel: "excellent"),Skill(skillName: "Programming", skillLevel: "great"),Skill(skillName: "Bachelor's Degree Healthcare or Data Science", skillLevel: "good")], preferences:["Creative environment", "Opportunities for professional development", "Work-life balance","Collaborative team","Fast-paced environment","Diverse projects","Creative freedom","Flexible hours","Team collaboration"], cv: "nil", suggestedCareerPaths: nil, applications: nil, firstName: "Muntadher", lastName: "Abdulrahman", email: "202203075@student.polytechnic.bh", password: "Scoobysnac77!", type: .jobSeeker, profileImage: "nil", phoneNumber: "39658382", location: "Malkiya")

...
let allApplications: [application] = [
    ...
    application(applicationNo: 20, dateOfApplication: "202†5-01-20", jobSeeker: SampleProfile2, isShortlisted: true, interview: nil, notes: nil, status: .accepted, jobTitle: "")
]

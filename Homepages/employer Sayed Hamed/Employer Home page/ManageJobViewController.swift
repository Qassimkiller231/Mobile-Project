...
class ManageJobViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {

    @IBOutlet weak var tableView: UITableView!

    // Data for drop-downs
    let jobTypes: [String] = ["Full-Time", "Part-Time", "Contract", "Internship"]
    let jobCategories: [String] = ["IT", "Finance", "Marketing", "Healthcare"]
    let jobPositions: [String] = ["Junior", "Mid-Level", "Senior", "Manager"]
    let salaryTypes: [String] = ["Hourly", "Monthly", "Yearly"]
    let skills: [String] = ["Swift", "Java", "Python", "UI/UX Design", "Data Analysis"]
    ...
    @objc func deadlineChanged(_ sender: UIDatePicker) {
        ...
        print("Selected Deadline: \(newJob.deadline)")
    }
